Feature: Implement Capstone Mini Project for Selnium Cucumber with java
 
Scenario: Verify given url and perform different operations
 ...
 And Navigate back to Home Page and Click on Frame
